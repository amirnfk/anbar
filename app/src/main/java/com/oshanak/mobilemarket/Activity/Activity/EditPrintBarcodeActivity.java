...
import com.oshanak.mobilemarket.Activity.Activity.Enum.EditPrintBarcodeActivityMode;
...
public class EditPrintBarcodeActivity extends BaseActivity implements OnTaskCompleted
{
    ...
    private EditPrintBarcodeActivityMode editPrintBarcodeActivityMode;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        supportRequestWindowFeature(Window.FEATURE_NO_TITLE);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_print_barcode);
        //////////////////////////////
        ...
        printBarcodeData = (PrintBarcodeData) intent.getSerializableExtra("printBarcodeData");

        tvItemID.setText(String.valueOf( printBarcodeData.getItemID()));
        tvItemName.setText(printBarcodeData.getItemName());
        etAmount.setText( ThousandSeparatorWatcher.addSeparator(printBarcodeData.getAmount()));
    ...
    private void initUnitSpinner()
    {
        ...
        unitData.setUnitName(printBarcodeData.getPartUnit());
        unitData.setAmount("1");
        list.add(unitData);

        unitData = new ProductUnitData();
        unitData.setUnitName(printBarcodeData.getWholeUnit());
        unitData.setAmount(String.valueOf( printBarcodeData.getBoxQuantity()));
        list.add(unitData);
    ...
    private void Update()
    {
        ...
        editPrintBarcodeActivityMode = EditPrintBarcodeActivityMode.BeforeUpdate;
        StoreHandheldService service = new StoreHandheldService(StoreHandheldServiceMode.UpdatePrintBarcode,this);

        service.addParam("ID", printBarcodeData.getID());
        service.addParam("amount", getPcAmount());
    ...
    public void onTaskCompleted(Object result)
    {
        ...
        else if(editPrintBarcodeActivityMode == EditPrintBarcodeActivityMode.BeforeUpdate)
        {
            ...
            editPrintBarcodeActivityMode = EditPrintBarcodeActivityMode.AfterUpdate;
            onBackPressed();
        }
    ...
    {
        if(editPrintBarcodeActivityMode == EditPrintBarcodeActivityMode.AfterUpdate )
        {
            printBarcodeData.setAmount(getPcAmount());

            Intent returnIntent = new Intent();
            returnIntent.putExtra("printBarcodeData", printBarcodeData);
